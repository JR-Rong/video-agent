...
class BilibiliOpenAPIUploader:
    def __init__(self, *, api_cfg: dict[str, Any], token_dir: str) -> None:
        ...
        self.token_path = os.path.join(token_dir, "bilibili.json")
    ...
    def build_authorize_url(self, state: str) -> str:
        raise NotImplementedError("Implement Bilibili OAuth authorize url.")

    def exchange_code_for_token(self, code: str) -> OAuthToken:
        raise NotImplementedError("Implement Bilibili code->token exchange.")

    def init_upload(self, *, access_token: str, file_size: int) -> dict[str, Any]:
        raise NotImplementedError("Implement Bilibili init upload.")

    def upload_file(self, *, upload_url: str, video_path: str) -> dict[str, Any]:
        raise NotImplementedError("Implement Bilibili upload file.")

    def publish(self, *, access_token: str, upload_result: dict[str, Any], task: UploadTask) -> dict[str, Any]:
        raise NotImplementedError("Implement Bilibili publish.")

    def upload(self, task: UploadTask) -> dict[str, Any]:
        token = self.load_token()
        if not token or not token.access_token:
            raise RuntimeError(f"Missing Bilibili OAuth token at {self.token_path}")
